...
class CountryDetailActivity : AppCompatActivity() {
    ...
    private fun findCaseData(country: String): Array<CaseInfo?> {
        ...
        when(country){
            ...
            "American Samoa" -> caseInfo = arrayOf(caseData!!.AmericanSamoa.All, historicCases!!.AmericanSamoa.All, historicDeaths!!.AmericanSamoa.All)
            ...
            "Czechia" -> caseInfo = arrayOf(caseData!!.Czechia.All, historicCases!!.Czechia.All, historicDeaths!!.Czechia.All)
            ...
            "Eswatini" -> caseInfo = arrayOf(caseData!!.Eswatini.All, historicCases!!.Eswatini.All, historicDeaths!!.Eswatini.All)
            ...
            "Heard and McDonald Islands" -> caseInfo = arrayOf(caseData!!.HeardAndMcDonaldIslands.All, historicCases!!.HeardAndMcDonaldIslands.All, historicDeaths!!.HeardAndMcDonaldIslands.All)
            "Holy See" -> caseInfo = arrayOf(caseData!!.HolySee.All, historicCases!!.HolySee.All, historicDeaths!!.HolySee.All)
            "Honduras" -> caseInfo = arrayOf(caseData!!.Honduras.All, historicCases!!.Honduras.All, historicDeaths!!.Honduras.All)
            "Hong Kong" -> caseInfo = arrayOf(caseData!!.HongKong.All, historicCases!!.HongKong.All, historicDeaths!!.HongKong.All)
            ...
            "Laos" -> caseInfo = arrayOf(caseData!!.Laos.All, historicDeaths!!.Laos.All, historicDeaths!!.Laos.All)
            ...
            "Macao" -> caseInfo = arrayOf(caseData!!.Macau.All, historicCases!!.Macau.All, historicDeaths!!.Macau.All)
            ...
            "Marshall Islands" -> caseInfo = arrayOf(caseData!!.MarshallIslands.All, historicCases!!.MarshallIslands.All, historicDeaths!!.MarshallIslands.All)
            ...
            "Micronesia" -> caseInfo = arrayOf(caseData!!.Micronesia.All, historicCases!!.Micronesia.All, historicDeaths!!.Micronesia.All)
            "Moldova" -> caseInfo = arrayOf(caseData!!.Moldova.All, historicCases!!.Moldova.All, historicDeaths!!.Moldova.All)
            ...
            "Montenegro" -> caseInfo = arrayOf(caseData!!.Montenegro.All, historicCases!!.Montenegro.All, historicDeaths!!.Montenegro.All)
            ...
            "Netherlands Antilles" -> caseInfo = arrayOf(caseData!!.NetherlandsAntilles.All, historicCases!!.NetherlandsAntilles.All, historicDeaths!!.NetherlandsAntilles.All)
            "New Caledonia" -> caseInfo = arrayOf(caseData!!.NewCaledonia.All, historicCases!!.NewCaledonia.All, historicDeaths!!.NewCaledonia.All)
            "New Zealand" -> caseInfo = arrayOf(caseData!!.NewZealand.All, historicCases!!.NewZealand.All, historicDeaths!!.NewZealand.All)
            ...
            "Papua New Guinea" -> caseInfo = arrayOf(caseData!!.PapuaNewGuinea.All, historicCases!!.PapuaNewGuinea.All, historicDeaths!!.PapuaNewGuinea.All)
            ...
            "Russia" -> caseInfo = arrayOf(caseData!!.Russia.All, historicCases!!.Russia.All, historicDeaths!!.Russia.All)
            "Rwanda" -> caseInfo = arrayOf(caseData!!.Rwanda.All, historicCases!!.Rwanda.All, historicDeaths!!.Rwanda.All)
            "Saint Kitts & Nevis" -> caseInfo = arrayOf(caseData!!.SaintKittsAndNevis.All, historicCases!!.SaintKittsAndNevis.All, historicDeaths!!.SaintKittsAndNevis.All)
            "Saint Lucia" -> caseInfo = arrayOf(caseData!!.SaintLucia.All, historicCases!!.SaintLucia.All, historicDeaths!!.SaintLucia.All)
            "Saint Vincent & Grenadines" -> caseInfo = arrayOf(caseData!!.SaintVincentAndTheGrenadines.All, historicCases!!.SaintVincentAndTheGrenadines.All, historicDeaths!!.SaintVincentAndTheGrenadines.All)
            "Samoa" -> caseInfo = arrayOf(caseData!!.Samoa.All, historicCases!!.Samoa.All, historicDeaths!!.Samoa.All)
            "San Marino" -> caseInfo = arrayOf(caseData!!.SanMarino.All, historicCases!!.SanMarino.All, historicDeaths!!.SanMarino.All)
            "Sao Tome & Principe" -> caseInfo = arrayOf(caseData!!.SaoTomeAndPrincipe.All, historicCases!!.SaoTomeAndPrincipe.All, historicDeaths!!.SaoTomeAndPrincipe.All)
            ...
            "Solomon Islands" -> caseInfo = arrayOf(caseData!!.SolomonIslands.All, historicCases!!.SolomonIslands.All, historicDeaths!!.SolomonIslands.All)
            "Somalia" -> caseInfo = arrayOf(caseData!!.Somalia.All, historicCases!!.Somalia.All, historicDeaths!!.Somalia.All)
            "South Africa" -> caseInfo = arrayOf(caseData!!.SouthAfrica.All, historicCases!!.SouthAfrica.All, historicDeaths!!.SouthAfrica.All)
            "South Georgia and the South Sandwich Islands" -> caseInfo = arrayOf(caseData!!.SouthGeorgiaAndTheSouthSandwichIslands.All, historicCases!!.SouthGeorgiaAndTheSouthSandwichIslands.All, historicDeaths!!.SouthGeorgiaAndTheSouthSandwichIslands.All)
            "Spain" -> caseInfo = arrayOf(caseData!!.Spain.All, historicCases!!.Spain.All, historicDeaths!!.Spain.All)
            "Sri Lanka" -> caseInfo = arrayOf(caseData!!.SriLanka.All, historicCases!!.SriLanka.All, historicDeaths!!.SriLanka.All)
            "St.Helena" -> caseInfo = arrayOf(caseData!!.StHelena.All, historicCases!!.StHelena.All, historicDeaths!!.StHelena.All)
            "Saint Pierre & Miquelon" -> caseInfo = arrayOf(caseData!!.StPierreAndMiquelon.All, historicCases!!.StPierreAndMiquelon.All, historicDeaths!!.StPierreAndMiquelon.All)
            ...
            "Svalbard and Jan Mayen Islands" -> caseInfo = arrayOf(caseData!!.SvalbardAndJanMayenIslands.All, historicCases!!.SvalbardAndJanMayenIslands.All, historicDeaths!!.SvalbardAndJanMayenIslands.All)
            ...
            "Syria" -> caseInfo = arrayOf(caseData!!.Syria.All, historicCases!!.Syria.All, historicDeaths!!.Syria.All)
            "Taiwan" -> caseInfo = arrayOf(caseData!!.Taiwan.All, historicCases!!.Taiwan.All, historicDeaths!!.Taiwan.All)
            "Tajikistan" -> caseInfo = arrayOf(caseData!!.Tajikistan.All, historicCases!!.Tajikistan.All, historicDeaths!!.Tajikistan.All)
            "Tanzania" -> caseInfo = arrayOf(caseData!!.Tanzania.All, historicCases!!.Tanzania.All, historicDeaths!!.Tanzania.All)
            "Thailand" -> caseInfo = arrayOf(caseData!!.Thailand.All, historicCases!!.Thailand.All, historicDeaths!!.Thailand.All)
            "Timor-Leste" -> caseInfo = arrayOf(caseData!!.TimorLeste.All, historicCases!!.TimorLeste.All, historicDeaths!!.TimorLeste.All)
            ...
            "Trinidad & Tobago" -> caseInfo = arrayOf(caseData!!.TrinidadAndTobago.All, historicCases!!.TrinidadAndTobago.All, historicDeaths!!.TrinidadAndTobago.All)
            ...
            "Turks and Caicos" -> caseInfo = arrayOf(caseData!!.TurksAndCaicosIslands.All, historicCases!!.TurksAndCaicosIslands.All, historicDeaths!!.TurksAndCaicosIslands.All)
            ...
            "United Arab Emirates" -> caseInfo = arrayOf(caseData!!.UnitedArabEmirates.All, historicCases!!.UnitedArabEmirates.All, historicDeaths!!.UnitedArabEmirates.All)
            "United Kingdom" -> caseInfo = arrayOf(caseData!!.UnitedKingdom.All, historicCases!!.UnitedKingdom.All, historicDeaths!!.UnitedKingdom.All)
            "United States" -> caseInfo = arrayOf(caseData!!.UnitedStates.All, historicCases!!.UnitedStates.All, historicDeaths!!.UnitedStates.All)
            "UnitedStates Minor Outlying Islands" -> caseInfo = arrayOf(caseData!!.UnitedStatesMinorOutlyingIslands.All, historicCases!!.UnitedStatesMinorOutlyingIslands.All, historicDeaths!!.UnitedStatesMinorOutlyingIslands.All)
            ...
            "Virgin Islands UK" -> caseInfo = arrayOf(caseData!!.VirginIslandsUK.All, historicCases!!.VirginIslandsUK.All, historicDeaths!!.VirginIslandsUK.All)
            "US Virgin Islands" -> caseInfo = arrayOf(caseData!!.VirginIslandsUS.All, historicCases!!.VirginIslandsUS.All, historicDeaths!!.VirginIslandsUS.All)
            ...
            "Western Sahara" -> caseInfo = arrayOf(caseData!!.WesternSahara.All, historicCases!!.WesternSahara.All, historicDeaths!!.WesternSahara.All)
